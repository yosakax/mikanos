...
// scan_device
/** @brief 指定のデバイス番号の書くファンクションをスキャンする
...
/** @brief 指定されたMSIケーパビリティ構造を読み取る
 *
 * @param dev MSIケーパビリティ構造を読み込むPCIデバイス
 * @param cap_addr MSIケーパビリティレジスタのコンフィグレーション空間アドレス
 *
 * */
